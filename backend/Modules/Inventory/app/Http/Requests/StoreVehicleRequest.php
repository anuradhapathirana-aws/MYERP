...
class StoreVehicleRequest extends FormRequest
{
    ...
    public function rules(): array
    {
        return [
            // Identity
            'vehicle_code'        => ['required', 'string', 'max:20', Rule::unique('inv_vehicle_masters', 'vehicle_code')->whereNull('deleted_at')],
            'registration_number' => ['required', 'string', 'max:50', Rule::unique('inv_vehicle_masters', 'registration_number')->whereNull('deleted_at')],
