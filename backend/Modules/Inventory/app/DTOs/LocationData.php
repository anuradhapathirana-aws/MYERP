...
final class LocationData
{
    ...
    public static function fromRequest(LocationRequest $request): self
    {
        ...
        return new self(
            ...
            open_hours_from:           $request->filled('open_hours_from') ? substr($request->input('open_hours_from'), 0, 5) : null,
            open_hours_to:             $request->filled('open_hours_to')   ? substr($request->input('open_hours_to'), 0, 5)   : null,
