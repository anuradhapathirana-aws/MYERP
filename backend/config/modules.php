...
return [
    ...
    */
    'stubs' => [
        ...
        'files' => [
            // web route stub intentionally omitted — API-only project
            'routes/api' => 'routes/api.php',
            'scaffold/config' => 'config/config.php',
            'composer' => 'composer.json',
            // view/asset/vite stubs intentionally omitted — API-only project
        ],
        'replacements' => [
            /**
    ...
    'paths' => [
        ...
        */
        'generator' => [
            ...
            // resource/ — disabled for API-only project
