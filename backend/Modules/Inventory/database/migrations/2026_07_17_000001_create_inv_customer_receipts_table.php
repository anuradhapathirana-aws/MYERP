...
return new class extends Migration
{
    ...
    {
        Schema::create('inv_customer_receipts', function (Blueprint $table): void {
            $table->id();

            // Auto-generated document number (e.g. RCP-0001)
            ...
            // Customer — soft link, no FK (consistent with Invoice's customer_id)
            $table->unsignedBigInteger('customer_id');

            $table->text('receipt_remark')->nullable();

            // Standalone advance (zero invoice allocations) support
    ...
    {
        Schema::dropIfExists('inv_customer_receipts');
    }
};
